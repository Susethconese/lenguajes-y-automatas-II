...
public class TablaSimbolos {
    ...
    public void crearTablaSimbolos() {
        ...
        for (int i = 0; i < this.tokenRC.size(); i++) {
            ...
            if (token.getTipo() == TipoToken.ENTERO || token.getTipo() == TipoToken.BOOLEANO|| token.getTipo() == TipoToken.DOUBLE|| token.getTipo() == TipoToken.STRING) {
//                simbolo.setTipoDato("Tipo de Dato");
    ...
    private boolean esValor(int tipoDato) {
        return tipoDato == TipoToken.NUM || tipoDato == TipoToken.TRUEX || tipoDato == TipoToken.FALSEX|| tipoDato == TipoToken.STRING|| tipoDato == TipoToken.DOUBLE || tipoDato == TipoToken.BOOLEANO;
    }
